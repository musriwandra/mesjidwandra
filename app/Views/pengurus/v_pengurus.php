...
<div class="col-sm-12">
      ...
      <div class="col-sm-12">
        <div class="card-m-b-30">
          <div class="card-header">
            <h4 class="mt-0 header-tittle">Data Pengurus</h4>
          </div>
                      ...
                      foreach ($pengurus as $val) {
                        ...
                        <tr role="row" class="odd">
                          ...
                          <td style="display: flex;">
                            ...
                            <button type="button" class="btn btn-info btn-sm btn-edit" data-id_pengurus="<?= $val['id_pengurus']; ?>" data-namapengurus="<?= $val['nama_pengurus'] ?>" data-jabatan="<?= $val['jabatan'] ?> " data-alamat="<?= $val['alamat'] ?>" data-nohp="<?= $val['no_hp'] ?>">
  ...
  <script>
    $('.btn-edit').on('click', function() {
      ...
      const namapengurus = $(this).data('namapengurus');
