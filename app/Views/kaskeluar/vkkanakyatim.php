            ...
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h4 class="mt-0 header-tittle text-center">Data Kas KeluarAnak Yatim</h4>
                    </div>
                    <div class="card-body">
...
<!-- TAMBAH DATA -->
<form action="/kaskeluar1/save" method="post">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Kas Keluar anakyatim</h5>
...
<!-- HAPUS DATA -->
<form action="/kaskeluar1/delete" method="post">
...
<!-- edit modal -->
<form action="/kaskeluar1/update" method="post">
