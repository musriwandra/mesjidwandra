            ...
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h4 class="mt-0 header-tittle text-center">Data Kas Keluar TPQ</h4>
                    </div>
                    <div class="card-body">
...
<!-- TAMBAH DATA -->
<form action="/kaskeluar1/savetpq" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>agenda</label>
                                    <button type="button" data-toggle="modal" data-target="#modal_kktpq" class="btn btn-xs btn-primary">Agenda</button>
                                </div>
                            </div>&nbsp; &nbsp;
                            <div class="col-md-3">
                                <div class="form-group">
...
<!-- HAPUS DATA -->
<form action="/kaskeluar1/deletetpq" method="post">
...
<!-- edit modal -->
<form action="/kaskeluar1/updatetpq" method="post">
...
<div class="modal fade" id="modal_kktpq">
