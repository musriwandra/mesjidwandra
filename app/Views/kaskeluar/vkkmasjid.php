            ...
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h4 class="mt-0 header-tittle text-center">Data Kas Keluar Mesjid</h4>
                    </div>
                    <div class="card-body">
...
<!-- TAMBAH DATA -->
<form action="/kaskeluar1/savemesjid" method="post">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Kas Keluar Mesjid</h5>
                ...
                <div class="modal-body">
                    <div class="col-md-12 mb-2">
                        <div class="row">
                            ...
                            <?php } ?>
                            <label for="" class="col-md-5">Total Kas Mesjid :</label>
                            <label for="" class="col-md-7"><?= $semua ?></label>
                        </div>
                    </div>
                    <div class="col-md-12 mb-2">
                        <label>Tanggal</label>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>agenda</label>
                                    <button type="button" data-toggle="modal" data-target="#modal_kkmesjid" class="btn btn-xs btn-primary">Agenda</button>
                                </div>
                            </div>&nbsp; &nbsp;
                            <div class="col-md-3">
                                <div class="form-group">
...
<!-- HAPUS DATA -->
<form action="/kaskeluar1/deletemesjid" method="post">
...
<!-- edit modal -->
<form action="/kaskeluar1/updatemesjid" method="post">
...
<div class="modal fade" id="modal_kkmesjid">
